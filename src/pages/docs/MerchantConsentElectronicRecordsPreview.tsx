...
const MerchantConsentElectronicRecordsPreview: React.FC = () => {
  ...
  const merchantName = business.legalNameOfBusiness ||fullName || 'Merchant';
...
export default MerchantConsentElectronicRecordsPreview;
